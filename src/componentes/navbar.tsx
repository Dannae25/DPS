            ...
            <div className="dropdown dropdown-end">
              <div tabIndex={0} role="button" className="btn btn-white btn-circle btn-sm md:btn-md ">
                <div className="indicator">
                  ...
                  <span className="badge badge-xs md:badge-sm indicator-item"></span>
                </div>
              </div>
              <div
                tabIndex={0}
                className="card card-compact dropdown-content bg-base-100 z-50 mt-3 w-40 md:w-50 shadow ">
                <div className="card-body">
                  <span className="text-sm md:text-lg font-bold">8 Items</span>
                  <span className="text-xs md:text-info">Subtotal: $999</span>
                  <div className="card-actions ">
                    <button className="btn btn-primary btn-block btn-sm">Ver Carrito</button>
                  </div>
                </div>
              </div>
            </div>
